...
근데 그 순간, 꿈의 궁전 모텔 간판이 보인다. <br/>
'이건,찬스다…!' <br/>
서둘러 폰을 꺼내, 몰래 스윽 자고가 어플을 킨다.<br/>
**내 위치 주변의 숙박을 검색**한다. 조금 비싼데? 내가 **보유중인 쿠폰을 조회**하니 쿠폰이 있다.<br/>
조심스럽게 썸녀한테 쓰윽 말을 건낸다. 
'저기 갈까?'  <br/>
<br/>

**일반유저_여자**  
썸남이 가리키는 모텔을 확인하고서 휴대폰을 스윽 꺼내 자고가 어플에서 **해당 숙박업소 상세정보**를 살펴본다.<br/>
**별점과 리뷰** 가 좋지 않네?<br/>
썸녀가 **별점이 높은 순으로 조회**하여 기가 막힌 곳을 찾았다.<br/>
오빠 내가 그냥 예약 할게~ 나 **VIP 회원**이야.   <br/>
<br/>

**사업자 유저**  
자신의 업소의 리뷰를 조회해보니 좋은리뷰가 가득해 행복해하는 업주. <br/>
작년 매출도 확인하며 기분이 더 좋아진다. <br/>
그리고 어젯밤 들어온 커플아 아까 퇴실해서 방을 청소하러 들어가는데...<br/>
왜 테이블이 부셔져있지..? <br/>
와 이새끼들… 고객센터로 들어가 상담원한테 채팅으로 어제 묵었던 **유저를 신고**해야겠다. <br/>
<br/>
...
![스크린샷 2024-12-03 150827](https://github.com/user-attachments/assets/88300d88-e325-4d06-8b88-d1e2a355ddc6)

![스크린샷 2024-12-03 151903](https://github.com/user-attachments/assets/047d42a0-a6f1-4fae-a44e-6409f82fdcbe)
...
### 이준서
**"협력으로 완료한 프로젝트였다"** <br/>
데이터베이스를 구축하고 개발자스러운 코드를 입력하기전에, <br/>
진행과정계획, 주제설정, 요구사항분석, 개념적설계 등등 각자 다른 생각들을 한데 모으는것이<br/>
한 프로젝트를 완성짓는 첫단추인 것 같다. 소통이 가장 중요하다 생각이 들었고,<br/>
쿼리들을 올리는데 사용한 git마저도 그랬다. <br/>
내겐 모든 과정들이 어렵고 모르는것들 투성이였다. <br/>
ERD를 구축할 때에는 관계설정에 많은 혼란을 겪었고, <br/>
회원가입과 쿠폰설정을 동시에 실행시켜주는 프로시저 구축에도 많은 어려움을 느꼈다. <br/>
그래도 완성한것만 해도 잘마무리했다고 생각한다. <br/>
팀원들의 열정과 노력에 많은 도움을 받았다고 생각합니다.모든 팀원분들 고생많으셨습니다. <br/>
