...
-- insert room
INSERT INTO room(accommodation_id, type, people_max, off_peak_season_price, peak_season_price, rent_price, count) VALUES
(1, '트윈', 2, 50000, 100000, 0, 5),
(2, '패밀리', 4, 80000, 1500000, 40000, 3),
(2, '트윈', 2, 40000, 100000, 40000, 10),
(3, '패밀리', 4, 100000, 180000, 0, 4),
(4, '트윈', 2, 60000, 100000, 0, 5),
(5, '트윈', 2, 80000, 100000, 30000, 8),
(6, '트윈', 2, 45000, 100000, 50000, 6),
(7, '트윈', 2, 100000, 200000, 0, 8),
(8, '패밀리', 4, 150000, 300000, 0, 2),
(9, '패밀리', 4, 100000, 2000000, 0, 1);
